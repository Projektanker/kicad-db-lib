...
var LibraryService = /** @class */ (function () {
    ...
    LibraryService.prototype.getSymbols = function (filter, reload, max) {
        return __awaiter(this, void 0, void 0, function () {
            var settings, directory, _a, filtered, error_2;
                ...
                switch (_b.label) {
                    ...
                    case 3:
                        filtered = this.symbols
                            .filter(function (s) { return s.toLowerCase().includes(filter.toLowerCase()); })
                            .slice(0, max);
    ...
    LibraryService.prototype.getFootprints = function (filter, reload, max) {
        return __awaiter(this, void 0, void 0, function () {
            var settings, directory, _a, filtered, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
